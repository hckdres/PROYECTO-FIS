    ...
    public void inicializarDB() {
        try (Connection conn = getConnection(); Statement stmt = conn.createStatement()) {
            ...
            stmt.execute("""
                    ...
                    """);
            stmt.execute("""
                    CREATE TABLE IF NOT EXISTS ModeloObjeto (
            ...
            stmt.execute("""
                    CREATE TABLE IF NOT EXISTS Objeto (
                        ...
                        FOREIGN KEY (idModelo) REFERENCES ModeloObjeto(idModelo),
            ...
            stmt.execute("""
                    CREATE TABLE IF NOT EXISTS ConciertoObjeto (
                        idConcierto INT,
                        idObjeto INT,
                        PRIMARY KEY (idConcierto, idObjeto),
